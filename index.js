  ...
  //       setTimeout(
  //         resolve,
  //         Math.floor(Math.random() * (2400000 - 1500000 + 1) + 1500000)
  //         // Math.floor(Math.random() * (300000 - 180000 + 1) + 180000) // to close browser between 3 to 5 minutes.
  //       );
  //     });
  //   } catch (error) {
  ...
  //         } else {
  //           const channel = client.channels.cache.get(jobTitles[0].keywordId);
  //           jobTitles.forEach(async (element) => {
  //             await channel.send(
  //               `New Job Posted: 🔷 ${element.title} \n 🔶 ${element.jobHref}`
  //             );
  //           });
